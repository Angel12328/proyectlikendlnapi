...
namespace LikendlnApi.Controllers
{
    public class CandidatoController : ApiController
    {
        ...
        /// <summary>
        /// obtiene informacion requeirda en el feed de un candidato
        /// </summary>
        /// <returns>Informacion basica del candidato</returns>
        [HttpGet]
        [SwaggerOperation("GetCandidatoFeedById")]
        [Route("api/GetCandidatoFedd/{id}")]
        public async Task<IHttpActionResult> GetCandidatoFeed(int id)
        {
        ...
        [HttpGet]
        [SwaggerOperation("GetCandidatoPublicionacionesById")]
        [Route("api/GetCandidatoPublicaciones/{id}")]
        public async Task<IHttpActionResult> GetCandidatoPublicaciones(int id)
        {

            var publicaciones = await db.Publicaciones
                .Where(p=>p.IdCandidato == id)
